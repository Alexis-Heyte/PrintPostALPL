...
#nullable disable
	...
	partial class NewEventPage
	{
		...
		private global::PrintPostClient.Controls.DateTimePicker dateTimePicker1;
		private global::PrintPostClient.Controls.DateTimePicker dateTimePicker2;
		...
		private void InitializeAfterConstructor()
		{
			...
			dateTimePicker1 = global::Microsoft.Maui.Controls.NameScopeExtensions.FindByName<global::PrintPostClient.Controls.DateTimePicker>(this, "dateTimePicker1");
			dateTimePicker2 = global::Microsoft.Maui.Controls.NameScopeExtensions.FindByName<global::PrintPostClient.Controls.DateTimePicker>(this, "dateTimePicker2");
			...
			if (this.BindingContext is global::PrintPostClient.ViewModels.NewEventViewModel dataRoot0)
			{
		...
		private void this_BindingContextChanged(object sender, global::System.EventArgs e)
		{
			...
			if (((global::Microsoft.Maui.Controls.Element)sender).BindingContext is global::PrintPostClient.ViewModels.NewEventViewModel dataRoot)
			{
		...
		class NewEventPage_Bindings_this
		{
			...
			global::PrintPostClient.ViewModels.NewEventViewModel _dataRoot;
			NewEventPage_BindingsTrackings_this _bindingsTrackings;

			public void Initialize(NewEventPage targetRoot, global::PrintPostClient.ViewModels.NewEventViewModel dataRoot)
			{
			...
			private void Update0(global::PrintPostClient.ViewModels.NewEventViewModel value)
			{
				Update0_Event(value);
				Update0_Title(value);
			...
			private void Update1(global::PrintPostClient.Models.Event value)
			{
			...
			private void Update0_Title(global::PrintPostClient.ViewModels.NewEventViewModel value)
			{
...
#line default
			...
			private void Update0_Event(global::PrintPostClient.ViewModels.NewEventViewModel value)
			{
...
#line default
			...
			private void Update0_SaveCommand(global::PrintPostClient.ViewModels.NewEventViewModel value)
			{
...
#line default
			...
			private void Update0_CancelCommand(global::PrintPostClient.ViewModels.NewEventViewModel value)
			{
...
#line default
			...
			private void Update1_Name(global::PrintPostClient.Models.Event value)
			{
#line (21, 17) - (21, 42) 21 "..\..\..\..\Views\NewEventPage.xaml"
...
#line default
			...
			private void Update1_Location(global::PrintPostClient.Models.Event value)
			{
...
#line default
			...
			private void Update1_StartsAt(global::PrintPostClient.Models.Event value)
			{
...
#line default
			...
			private void Update1_EndsAt(global::PrintPostClient.Models.Event value)
			{
...
#line default
			...
			private void Update1_Notes(global::PrintPostClient.Models.Event value)
			{
...
#line default
			...
			class NewEventPage_BindingsTrackings_this
			{
				...
				public void SetPropertyChangedEventHandler0(global::PrintPostClient.ViewModels.NewEventViewModel value)
				{
				...
				public void SetPropertyChangedEventHandler1(global::PrintPostClient.Models.Event value)
				{
				...
				private void OnPropertyChanged0(object sender, global::System.ComponentModel.PropertyChangedEventArgs e)
				{
					...
					var typedSender = (global::PrintPostClient.ViewModels.NewEventViewModel)sender;
				...
				private void OnPropertyChanged1(object sender, global::System.ComponentModel.PropertyChangedEventArgs e)
				{
					...
					var typedSender = (global::PrintPostClient.Models.Event)sender;
					switch (e.PropertyName)
					{
						case null:
						case "":
